...
export async function GET() {
  try {
    ...
    const defectiveProductsTotal = stockLog
      .filter((log) => log.type === 'DEFECTUOSO') // Filtrar por el tipo "DEFECTIVE"
    ...
    // Calcular la suma de productos producidos (PRODUCED)
    const producedProductsTotal = stockLog
      .filter((log) => log.type === "PRODUCIDO")
    ...
    return NextResponse.json({
      ...
      producedProductsTotal, // Total de productos producidos
...
//   }
// }
// //API PARA EL COMPONENTE RESUMEN-STOCK
